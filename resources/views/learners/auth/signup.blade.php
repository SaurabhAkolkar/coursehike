          ...
          <div class="la-entry__content-wrap d-flex flex-column justify-content-center">
            <div class="la-entry__content-top">
              <form class="la-entry__form" action="">
                          ...
                          <div class="la-form__input-wrap la-entry__input-wrap mb-12"><span class="la-entry__input-icon"><span class="la-icon la-icon--lg icon-confirm-password"></span></span>
