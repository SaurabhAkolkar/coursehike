...
@section('seo_content')
    <title> Purchase History | Learn Tattoo & Graphic Design | LILA </title>
    ...
    <meta property="og:title" content="Purchase History | Learn Tattoo & Graphic Design | LILA" />
    ...
    <meta name="twitter:title" content="Purchase History | Learn Tattoo & Graphic Design | LILA" />
    <meta name="twitter:site" content="@lilaaliens" />

    <script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"Purchase History | Learn Tattoo & Graphic Design | LILA"}</script>
@endsection
