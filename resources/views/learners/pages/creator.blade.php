...
@section('seo_content')
    <title>{{$creator->FullName}} | Mentor Profile | Learn Tattoo & Graphic Design | LILA</title>
    <meta name='description' itemprop='description' content='Fill your details,your accomplishements Let the world and your students know how you carved your niche in the world of Tattoo design.' />

    <meta property="og:description" content="Fill your details,your accomplishements Let the world and your students know how you carved your niche in the world of Tattoo design." />
    <meta property="og:title" content="{{$creator->FullName}} | Mentor Profile | Learn Tattoo & Graphic Design | LILA" />
    ...
    <meta name="twitter:title" content="{{$creator->FullName}} | Mentor Profile | Learn Tattoo & Graphic Design | LILA" />
    <meta name="twitter:site" content="@lilaaliens" />
    
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"{{$creator->FullName}} | Mentor Profile | Learn Tattoo & Graphic Design | LILA"}</script>
@endsection
        ...
        <div class="container-fluid">
              <div class="row pt-18 pb-8 pt-md-10 pb-md-10">   
                  <div class="col-12 la-anim__wrap">
                    <h4 class="text-xl text-md-2xl px-0 pb-6 pb-lg-8 la-anim__stagger-item">Courses from <span class="text-capitalize"> {{ucfirst($creator->FullName)}}</span></h4>
              ...
              <div class="row pt-6 pb-10 pt-md-10 pb-md-16">   
                  <div class="col-12 la-anim__wrap">
                    <h4 class="text-xl text-md-2xl px-0 pb-6 pb-lg-8 la-anim__stagger-item">Classes from <span class="text-capitalize"> {{ucfirst($creator->FullName)}}</span></h4>
