    ...
    <div class="la-section__inner">
      <div class="container-fluid la-anim__wrap">
        <div class="la-anim__stagger-item">
          ...
          <h1 class="la-page__title mb-3 mb-lg-8">Browse Classes</h1>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap flex-column flex-md-row">
            ...
            <div class="la-gsearch mb-0 la-anim__stagger-item">
              <form class="form-inline m-0"  action="{{ url('/search-classes/') }}">
            ...
            <div class="la-courses__nav-filters  d-flex align-items-start ml-auto ml-md-6 ">
              <div class="la-courses__nav-props d-none d-xl-block">
                @if(!$filtres_applied)
                        ...
                        <div class="tab-content la-courses__nav-content position-relative" id="nav-tabContent">
                              ...
                              <div class="tab-pane fade show la-anim__wrap @if ($loop->first) active @endif" id="nav-{{$category->slug}}" role="tabpanel" aria-labelledby="nav-{{$category->slug}}-tab">
                                      ...
                                      <div class="swiper-container  la-courses__featured-container">
                                        <h5 class="la-courses__featured-title mb-5 mb-lg-8 ml-0 ml-lg-2 la-anim__stagger-item">Featured Classes</h5>
                                        <div class="swiper-wrapper la-courses__featured-wrapper ">
                                          ...
                                          @if(count($courses) == 0 || count($courses->where('featured','like','1')) == 0 )
                                              ...
                                              <div class="mb-3 mb-md-8 la-empty__courses la-anim__wrap">
                                      ...
                                      <div class="la-courses__other la-section__small">
                                        <h5 class="la-courses__featured-title mb-5 mb-lg-8 la-anim__stagger-item">Other Classes</h5>
                                        <div class="row row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
                                          @php
                                        ...
                                        @if(count($courses) == 0 || count($merged) == 0 )
                                          ...
                                          <div class=" my-3 my-md-8  la-empty__courses la-anim__wrap">
                                            <div class="la-empty__inner text-center mb-0">
