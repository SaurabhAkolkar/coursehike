          ...
          <div class="col-12 la-anim__wrap">
            ...
            <div class="la-empty__courses d-md-flex justify-content-between align-items-start la-anim__wrap">
              <div class="la-empty__inner">
                  ...
                  <p class="la-empty__course-desc m-0 la-anim__stagger-item">You currently don't have any ongoing course, start new course</p>
              </div>
              <div class="la-empty__browse-courses ">
                  <a href="{{Url('/browse/courses')}}" class="la-empty__browse la-anim__stagger-item">
                      Browse Courses
