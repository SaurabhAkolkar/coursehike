...
@section('seo_content')
    <title>My Interests | Learn Tattoo & Graphic Design | LILA </title>
    <meta name='description' itemprop='description' content='Check out all your Interests tattoo, graphic design you subscribed.' />

    <meta property="og:description"content="Check out all your Interests tattoo, graphic design you subscribed" />
    <meta property="og:title"content="My Interests | Learn Tattoo & Graphic Design | LILA " />
    ...
    <meta name="twitter:title"content="My Interests | Learn Tattoo & Graphic Design | LILA " />
    <meta name="twitter:site"content="@lilaaliens" />

    <script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"My Interests | Learn Tattoo & Graphic Design | LILA"}</script>
@endsection
