                  ...
                  <div class="row ">
                    ...
                    <div class="col-md-12 la-anim__stagger-item--x">
                                    <div class="la-form__input-wrap">
                                      ...
                                      <input class="la-form__input" type="text" value="@if(Auth::user()->address==""){{ old('address') }}@else{{ Auth::user()->address }}@endif" name="address" placeholder="Enter your Residential Address">
                                      @error('address')
                                          <div class="alert alert-danger">{{ $message }}</div>
                                      @enderror
                                    </div>
