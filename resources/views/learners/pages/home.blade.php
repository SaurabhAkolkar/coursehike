...
@section('seo_content')
    ...
    <meta name='description' itemprop='description'
        content='Creative online course for creative minds. Discover & learn classes on art,design, baking, tattoo making & much more. Start your free trial with LILA now' />
...
@section('content')
    ...
    @if (session('success'))
        <div class="la-btn__alert position-relative">
            <div class="la-btn__alert-success col-lg-4 offset-lg-4  alert alert-success alert-dismissible fade show"
                role="alert">
                ...
                <div class="col-12 position-relative my-auto">
                    @if ($firstSection->video_url == null)
                        <div class="la-hero__img position-relative d-flex align-items-center">
                            ...
                            <img class="img-fluid ml-auto la-hero__img-bg" src="{{ $firstSection->image }}"
                                alt="{{ $firstSection->image_text }}" />
                        </div>
                    @else
                        <!-- Video Section: Start -->
                        <div class="la-hero__video-main position-relative">
                            <div class="la-hero__video">
                                <video autoplay playsinline muted loop id="home_video"
                                    poster="../images/learners/home/home-fallback.jpg">
                    ...
                    <div
                        class="container-fluid la-hero la-hero__video-content d-flex justify-content-center flex-column align-items-center">
                        <div class="la-hero__video-info text-center text-md-left">
                            <p class="la-hero__tag mb-2 mb-md-0 d-none d-md-block">Ace the learning curve with Courses &
                                Classes by</p>
                            <p class="la-hero__tag mb-2 mb-md-0 d-block d-md-none">Courses & Classes by</p>
                            <h1 class="la-hero__title mb-5">World’s Finest <span class="la-hero__subtitle">Artists</span>
                            </h1>
                                    ...
                                    @if (Auth::check() &&
                                        ...
                                        <div class="">
                                            <a href="/browse/courses"
                                                class="btn btn-primary la-hero__cta la-btn__app active text-white px-md-4">Start
                                                Learning</a>
                                        </div>
                                    @else
                                        <div class="">
                                            <a href="/learning-plans"
                                                class="btn btn-primary la-hero__cta la-btn__app active text-white  px-md-4"
                                                style="letter-spacing:1.5px">
                                                Subscribe for
                                                <span class="la-soffer__bestprice la-home__bestprice"
                                        ...
                                        <div
                                            class="la-soffer mt-2 d-inline-flex justify-content-center flex-column align-items-md-center">
                          ...
                          @endif
                                            ...
                                            @if (getLocation() == 'IN')
                                                <div class="la-soffer__realprice la-home__realprice"
                                                    style="color:var(--white)"> <sup>₹</sup> 5999 (INR)</div>
                                            @else
                                                <div class="la-soffer__realprice la-home__realprice"
                                                    style="color:var(--white)"> <sup>$</sup> 99 (USD)</div>
                                            @endif
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="la-hero__bottom-trial mt-6 mt-md-2 ml-md-6">
                                    @if (Auth::check() &&
                                            ...
                                            Auth::User()->subscription()->active())
                                    @else
                                        <a href="/learning-plans" class="btn btn-primary la-btn__app text-white px-md-4"
                                            style="letter-spacing:1.8px">Start free trial</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="la-hero__btn--scroll-down">
                            <div
                                class="la-hero__bottom-browse la-btn__arrow la-btn__arrow-down text-uppercase text-white text--md font-weight--medium text-spacing d-none d-md-block">
                                <a href="#home_courses" id="home_courses_redirect">BROWSE COURSES
                                    <span class="la-btn__arrow-icon arrow-down la-icon la-icon--7xl icon-grey-arrow">
                                    </span>
                                </a>
                            </div>
                        </div>
        ...
        <div class="la-section__inner la-section--courses-inwrap">
            <div class="container-fluid la-home__course-fluid position-relative" id="home_fluid_container">
                <div class="la-courses">
                    <h3 class="la-home__course-mtitle mb-3 mb-md-10">Start your Journey!</h3>
                    {{-- <h2 class="la-courses__nav-content--title mb-3 mb-md-6 text-center">Featured Classes</h2> --}}

                    <nav
                        class="la-courses__nav mb-3 mb-md-3 d-inline-flex justify-content-start justify-content-md-center position-relative">
                        <ul class="nav nav-pills la-courses__nav-tabs justify-content-center" id="nav-tab" role="tablist"
                            tabindex="0">
                  ...
                  <li class="nav-item la-courses__nav-item"><a class="nav-link la-courses__nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false"> <span class="position-relative">Design</span></a></li> --}}
                    ...
                    <x-add-to-playlist :playlists="$playlists" />
                    {{-- Categories Tab :Start --}}

                    <div class="tab-content la-courses__nav-content position-relative pt-0 " id="nav-tabContent">
                        @foreach ($categories as $category)
                            <div class="position-relative tab-pane fade show @if ($loop->first) active @endif"
                                ...
                                <div class="la-courses__nav-content--classes">
                                    ...
                                    <div class="swiper-container la-home__course-container2">
                                            ...
                                            {{-- @foreach ($courses as $course)
                                                <div class="swiper-slide la-home__course-slide2 pt-md-6">
                                                    <x-course :id="$course->id" :img="$course->preview_image" :course="$course->title"
                                                        ...
                                                        :creatorName="$course->user->fullName" :creatorUrl="$course->user->id" :learnerCount="$course->learnerCount"
                                        ...
                                        @if (count($courses) != 0)
                                            <div
                                                class=" mt-10 w-100 text-center d-md-flex justify-content-between align-items-start">

                                                <div
                                                    class="la-slider__navigations2 la-home__course-navigations d-md-flex  align-items-center">
                                                    <!-- <div class="swiper-button-prev la-slider__navigations-arrow la-home__course-prev"></div> -->
                                                    <div
                                                        class="swiper-pagination la-slider__navigations-dots2 la-home__course-paginations2 la-slider__paginations2  la-slider__paginations--purble la-right">
                                                    </div>
                                                ...
                                                <div class=" position-relative text-center text-md-right pb-2">
                                                    <div
                                                        class=" la-btn__arrow text--burple text-uppercase text-spacing font-weight--medium mr-1 mr-md-7">
                                                        <a href="/browse/classes">explore more <span
                                                                class="la-btn__arrow-icon la-icon la-icon--7xl icon-grey-arrow"></span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                    ...
                                    <div class="swiper-container la-home__course-container">
                                        ...
                                        @if (count($courses) != 0)
                                            <div
                                                ...
                                                <div
                                                    class="la-slider__navigations la-home__course-navigations d-md-flex  align-items-center">
                                                    <!-- <div class="swiper-button-prev la-slider__navigations-arrow la-home__course-prev"></div> -->
                                                    <div
                                                        class="swiper-pagination la-slider__navigations-dots la-home__course-paginations la-slider__paginations la-slider__paginations--purble la-right">
                                                    </div>
                                                    <!-- <div class="swiper-button-next la-slider__navigations-arrow la-home__course-next"></div> -->
                                                </div>
                                                <div class=" position-relative text-center text-md-right pb-2">
                                                    <div
                                                        class=" la-btn__arrow text--burple text-uppercase text-spacing font-weight--medium mr-1 mr-md-7">
                                                        <a href="/browse/courses">explore more <span
                                                                class="la-btn__arrow-icon la-icon la-icon--7xl icon-grey-arrow"></span></a>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <section class="la-section--artists position-relative">
        <div class="la-section__inner position-relative">
            ...
            <h2 class="d-block d-md-none text-center la-section__title la-section__title--big position-relative"
                style="z-index:4;">Lila Mentors</h2>
            <div class="swiper-container gallery-top la-artist__slider container-fluid">

                <div class="swiper-wrapper">
                    <div class="d-none d-md-block">
                        <div
                            class="la-artist__designation la-artist__designation--front position-absolute w-50 pt-10 my-auto d-flex align-items-center justify-content-left">
                            <h2
                                class="la-artist__designation-title mb-0  d-flex flex-row justify-content-center align-items-center">
                                <span style="opacity:0.25">Lila</span>
                            </h2>
                        </div>

                        <div
                            class="la-artist__designation position-absolute w-100 pt-10 my-auto d-flex align-items-center justify-content-center">
                            <h2
                                class="la-artist__designation-title mb-0  d-flex flex-row justify-content-center align-items-center">
                    ...
                    @foreach ($featuredMentor as $feat)
                        <x-artist :artistName="ucfirst($feat->user->fullName)" :artistImage="$feat->user_image" :artistCategory="$feat->courses->category->title" :artistCampany="$feat->courses->title"
                            :course="$feat->courses" :artistId="$feat->user->id" />
                    @endforeach
                </div>
            </div>
            ...
            <div class="swiper-container gallery-thumbs la-artist__thumbnails-wrap">
                <div class="swiper-wrapper la-artist__thumbnails">
                    ...
                    @foreach ($featuredMentor as $feat)
                        <div class="swiper-slide la-artist__thumbnail"><img src="{{ $feat->user_thumbnail }}"
                                alt="FM" class="d-block" /></div>
                    @endforeach
    ...
    <section class="la-section la-section--dark la-section--classes position-relative">
        <div class="la-section__inner">
            <div class="la-home__master-fluid">
                <div class="">
                    <h2
                        class="la-section--classes-title text-center la-section__title la-section__title--big  position-relative ">
                        Master <span>classes</span></h2>
                </div>
                ...
                <div class="la-mccourses pt-20 pt-md-6">
                            ...
                            @foreach ($master_classes as $master)
                                @if ($master->courses != null)
                                    <div class="swiper-slide la-home__master-slide">
                                        <x-master-class :img="$master->courses->preview_image" :title="$master->courses->title" :url="$master->courses->slug"
                                            :profileImg="$master->courses->user->user_img" :profileName="$master->courses->user->fullName" :learners="$master->courses->learnerCount" :id="$master->courses->id"
                                            :slug="$master->courses->slug" :price="$master->courses->price" :bought="$master->courses->isPurchased()" :checkWishList="$master->courses->checkWishList"
                    ...
                    <div
                        class="container-fluid  w-100 text-center d-md-flex justify-content-between align-items-start mt-6 mt-md-16">
                        <div class="la-slider__navigations la-home__course-navigations d-md-flex align-items-center">
                            ...
                            <div
                                class="swiper-pagination la-slider__navigations-dots la-home__master-pagination la-slider__paginations la-slider__paginations--purble la-right">
                            </div>
                        ...
                        <div class="la-mccourse__view-more position-relative text-center text-md-right ">
                            <div
                                class=" la-btn__arrow text-white text-uppercase text-spacing font-weight--medium mr-1 mr-md-1">
                                <a href="/master-classes">explore more <span
                                        class="la-btn__arrow-icon la-icon la-icon--7xl icon-grey-arrow"></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 d-inline-flex my-auto">
                        <div class="swiper-container la-home__watch-container">
                            <div class="swiper-wrapper la-home__watch-wrapper">
                                ...
                                <div class="swiper-slide la-home__watch-slide position-relative"
                                    style="background:url('../../images/learners/home/watch-bg1.jpg') no-repeat center top;">
                                    <div
                                        class="la-home__watch-overlay d-flex flex-column justify-content-around align-items-start h-100">
                                        <span class="la-home__watch-artist d-none d-lg-block">Artists Choice</span>
                                        <div
                                            class="col-md-8 col-xl-6 la-home__watch-content my-auto d-flex flex-column justify-content-center">
                                            <span class="la-home__watch-artist--mobile d-block d-lg-none">Artists
                                                Choice</span>
                                            <h2 class="la-home__watch-title mb-3">Realistic Portrait Tattoo of Muhammad Ali
                                            </h2>
                                            <p class="la-home__watch-para">This is one of the most comprehensive tattoo
                                                courses ever designed by master artist Sunny Bhanushali. This course is full
                                                of his tried and tested techniques, they will be really useful in your
                                                tattoo process! Wondering how professional artists make photo-realistic
                                                tattoos/portrait tattoos look so easy?</p>

                                            <div class="mt-6">
                                                <a role="button"
                                                    href="https://lila.art/learn/class/98/realistic-portrait-tattoo-of-muhammad-ali"
                                                    class="btn btn-primary la-btn__app active"> Watch Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide la-home__watch-slide position-relative"
                                    style="background:url('../../images/learners/home/watch-bg2.jpg') no-repeat center top;">
                                    <div
                                        class="la-home__watch-overlay d-flex flex-column justify-content-around align-items-start h-100">
                                        <span class="la-home__watch-artist d-none d-lg-block">Artists Choice</span>
                                        <div
                                            ...
                                            <span class="la-home__watch-artist--mobile d-block d-lg-none">Artists
                                                Choice</span>
                                            <h2 class="la-home__watch-title mb-3">Realistic Portrait of Marilyn Monroe -
                                                Advanced Course</h2>
                                            <p class="la-home__watch-para">Watch how Black & Grey Realism Expert, Allan
                                                Gois, walks you through the making of this Portrait Tattoo of Marilyn
                                                Monroe. From the perfect shading techniques to finishing your tattoo without
                                                skin damage, we'll look at how experts render customised portrait tattoos to
                                                get the best outputs.</p>

                                            <div class="mt-6">
                                                <a role="button"
                                                    href="https://lila.art/learn/class/97/realistic-portrait-of-marilyn-monroe-advanced-course"
                                                    class="btn btn-primary la-btn__app active"> Watch Now</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide la-home__watch-slide position-relative"
                                    style="background:url('../../images/learners/home/watch-bg3.png') no-repeat center top;">
                                    <div
                                        class="la-home__watch-overlay d-flex flex-column justify-content-around align-items-start h-100">
                                        <span class="la-home__watch-artist d-none d-lg-block">Artists Choice</span>
                                        <div
                                            ...
                                            <p class="la-home__watch-para">Learn Colour Realism from the legendary artist
                                            </p>

                                            <div class="mt-6">
                                                <a role="button"
                                                    href="https://lila.art/learn/class/75/master-class-steve-butcher"
                                                    class="btn btn-primary la-btn__app active"> Watch Now</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div
                                class="la-slider__navigations la-home__watch-navigations d-flex align-items-center justify-content-end">
                                <div
                                    class="swiper-pagination la-slider__navigations-dots la-home__watch-pagination la-slider__paginations la-slider__paginations--purble la-right">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 my-auto h-100">
                        <div class="la-home__customize position-relative">
                            <h3 class="la-home__customize-title position-relative">Customized Learning with you in mind!
                            </h3>
                            <p class="la-home__customize-para mb-0">A learning platform just for you. An approach that aims
                                to customize learning for each student's strengths, needs, skills, and interests.</p>

                            <div
                                class="la-btn__arrow la-btn__text--yellow text-uppercase text-spacing font-weight--medium mr-5 mr-md-1">
                                <a
                                    @if (Auth::check()) href="/user-dashboard" @else data-toggle="modal" data-target="#locked_login_modal" @endif>explore
                                    more <span class="la-btn__arrow-icon la-icon la-icon--7xl icon-grey-arrow"></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 position-relative la-home__customize-sliders  w-100 ">
                        ...
                        <div class="la-home__customize-right position-relative mx-auto"
                            style="background:url('../../images/learners/home/clslider.svg') no-repeat center;">
                            <div id="la-home-customize-laptop"
                                class="swiper-container la-home__customize-container la-home__customize-container--desktop position-relative">
                                <div class="swiper-wrapper la-home__customize-wrapper la-home__customize-wrapper--desktop">
                                    <div class="swiper-slide la-home__customize-slide la-home__customize-slide--desktop"
                                        data-swiper-autoplay="1500" href="#clm_dashboard">
                                        <div class="la-home__customize-info--desktop">
                                            <img src="./images/learners/home/clap1.jpg"
                                                data-src="./images/learners/home/clap1.jpg" alt="Personalised dashboard"
                                                class="img-fluid mx-auto d-block la-home__customize-img lazy" />
                                        </div>
                                    </div>

                                    <div class="swiper-slide la-home__customize-slide la-home__customize-slide--desktop"
                                        data-swiper-autoplay="1500" href="#clm_course">
                                        <div class="la-home__customize-info--desktop">
                                            <img src="./images/learners/home/clap2.jpg"
                                                data-src="./images/learners/home/clap2.jpg" alt="Unique tattoo styles"
                                                class="img-fluid mx-auto d-block la-home__customize-img lazy" />
                                        </div>
                                    </div>

                                    <div class="swiper-slide la-home__customize-slide la-home__customize-slide--desktop"
                                        data-swiper-autoplay="1500" href="#clm_playlist">
                                        <div class="la-home__customize-info--desktop">
                                            <img src="./images/learners/home/clap3.jpg"
                                                data-src="./images/learners/home/clap3.jpg" alt="Personal Playlist"
                                                class="img-fluid mx-auto d-block la-home__customize-img lazy" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="la-home__customize-mobile--section">
                            <div class="la-home__customize-right--mobile"
                                style="background:url('../../images/learners/home/cmslider.svg') no-repeat center;">
                                <div id="la-home-customize-mobile"
                                    class="swiper-container la-home__customize-container la-home__customize-container--mobile position-relative">
                                    <div
                                        class="swiper-wrapper la-home__customize-wrapper la-home__customize-wrapper--mobile">
                                        <div class="swiper-slide la-home__customize-slide la-home__customize-slide--mobile"
                                            data-swiper-autoplay="1500" href="#clm_dashboard">
                                            <div class="la-home__customize-info--mobile">
                                                <img src="./images/learners/home/cmob1.jpg" alt="Personalised dashboard"
                                                    class="img-fluid mx-auto d-block la-home__customize-img" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="swiper-slide la-home__customize-slide la-home__customize-slide--mobile"
                                            data-swiper-autoplay="1500" href="#clm_course">
                                            <div class="la-home__customize-info--mobile">
                                                <img src="./images/learners/home/cmob2.jpg" alt="Unique tattoo styles"
                                                    class="img-fluid mx-auto d-block la-home__customize-img" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="swiper-slide la-home__customize-slide la-home__customize-slide--mobile"
                                            data-swiper-autoplay="1500" href="#clm_playlist">
                                            <div class="la-home__customize-info--mobile">
                                                <img src="./images/learners/home/cmob3.jpg" alt="Personal Playlist"
                                                    class="img-fluid mx-auto d-block la-home__customize-img" />
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-8 offset-lg-4 la-home__customize-container--content-wrap">
                        <div id="la-home-customize-content"
                            class="swiper-container la-home__customize-container la-home__customize-container--content pl-md-3">
                            <div class="swiper-wrapper la-home__customize-wrapper">
                                <div class="swiper-slide la-home__customize-slide col-md-8 px-0"
                                    ...
                                    <div class="la-home__customize-desc" id="clm_dashboard">
                                        <div class="la-home__customize-infotitle leading-tight mt-8">Personalised dashboard
                                            for focused learning</div>
                                        <p class="la-home__customize-infopara">Courses based on your interests, favourite
                                            mentors, on one easy learning platform</p>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide la-home__customize-slide col-md-8 px-0"
                                    ...
                                    <div class="la-home__customize-desc" id="clm_course">
                                        <div class="la-home__customize-infotitle leading-tight mt-8">Unique tattoo styles
                                            from around of the world</div>
                                        <p class="la-home__customize-infopara">Learn unique styles created by incredible
                                ...
                                <div class="swiper-slide la-home__customize-slide col-md-8 px-0"
                                    ...
                                    <div class="la-home__customize-desc" id="clm_playlist">
                                        <div class="la-home__customize-infotitle leading-tight mt-8">Personal Playlist to
                                            help you organise</div>
                                        <p class="la-home__customize-infopara">Create playlist to save all the courses you
                                            want to learn in a personal space and learn whenever, wherever yo want!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                class="swiper-pagination la-slider__navigations-dots la-home__customize-pagination la-slider__paginations la-slider__paginations--purble la-right">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="la-trail__title-main la-anim__pin">
                            <div class="swiper-container la-trail__title-container ">
                                <div class="swiper-wrapper la-trail__title-wrapper">
                                    <div class="swiper-slide la-trail__title-slide">
                                        <div
                                            class="la-trail__title text-left la-trail__title--purple la-section__title la-section__title--big">
                                            Observe</div>
                                    </div>
                                    <div class="swiper-slide la-trail__title-slide">
                                        <div
                            ...
                            <h2
                                class="la-section__title la-section__title--big leading-none la-price__container-title text-left">
                                ...
                                <div class="col-lg-5">
                                    <div class="la-home__subscription-main ">
                                        <div class="la-home__subscription-ques la-home__subscription__ques--first">
                                            <h3 class="la-section__subtitle la-home__subscription-title">LILA's way of
                                                teaching</h3>
                                            <p class="la-section__text text-md text-md-lg">We strongly believe observation
                                                is integral to honing art. Learn from artists who have created their niche
                                                in the world of tattooing with consistent practice, and become the master of
                                                your niche!</p>
                                            <div
                                                class="la-btn__arrow text--burple text-uppercase text-spacing font-weight--medium pt-4 pt-md-8">
                                                <a href="/about">learn more<span
                                                        class="la-icon la-icon--7xl icon-grey-arrow la-btn__arrow-icon"></span></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="la-home__subscription-ques la-home__subscription__ques--second">
                                            ...
                                            <p class="la-section__text text-md text-md-lg">Learning need not be expensive.
                                                At LILA, our subscription model gives you the benefit to choose from any
                                                number of courses or individual classes, as you please.</p>
                                            <p class="la-section__text text-md text-md-lg"> All at nominal fees! So, learn
                                                away! </p>
                                            <div
                                                class="la-btn__arrow text--burple text-uppercase text-spacing font-weight--medium pt-4 pt-md-8">
                                                <a href="/learning-plans">learn more<span
                                                        class="la-icon la-icon--7xl icon-grey-arrow la-btn__arrow-icon"></span></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="la-home__subscription-ques la-home__subscription__ques--third">
                                            ...
                                            <p class="la-section__text text-md text-md-lg">Our mission is to Encourage,
                                                Empower and Embrace self-learning among all curious individuals who wish to
                                                learn, expand their potential and make a mark in the world.</p>
                                            <p class="la-section__text text-md text-md-lg"> Through our Radical team, we
                                                strive every day to make knowledge Affordable, Accessible for everyone
                                                regardless of who or where they are</p>
                                            <div
                                                class="la-btn__arrow text--burple text-uppercase text-spacing font-weight--medium  pt-4 pt-md-8 ">
                                                <a href="/about">learn more<span
                                                        class="la-icon la-icon--7xl icon-grey-arrow la-btn__arrow-icon"></span></a>
                                            ...
                                            <div class="la-anim__wrap ">
                                                <div class="la-price__box la-anim__pin2 ">
                                                    <div class="la-price__box-inner">
                                                        <p class="la-price__box-para mb-8">Discover our wide range of art
                                                            courses curated by top artists from around the world and explore
                                                            your creativity! </p>
                                                        <a href="/browse/course"
                                                            class="btn btn-primary la-btn w-100">Start Learning</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="la-price__box-wrap">
                                            <div class="la-anim__wrap la-anim__wrap-pin2">
                                                <div class="la-price__box la-anim__pin2 ">
                                                    <div class="la-price__box-inner">
                                                        <a href="/learning-plans"
                                                            class="btn btn-primary la-btn__app w-100">SUBSCRIBE NOW</a>
                                                        <p class="la-price__box-para mt-8 mb-2">Get <span
                                                                class="la-color--primary">35% savings </span>on Annual Plan
                                                        </p>
