...
@section('seo_content')
    <title> Terms & Conditions | Learn Tattoo & Graphic Design | LILA </title>
    ...
    <meta property="og:title" content="Terms & Conditions | Learn Tattoo & Graphic Design | LILA" />
    ...
    <meta name="twitter:title" content="Terms & Conditions | Learn Tattoo & Graphic Design | LILA" />
                    ...
                    <div class="la-cr__section la-anim__wrap">
                        <div class="la-cr__section-index pt-6">
                            ...
                            <ol class="la-cr__section-list la-anim__stagger-item">
                                <li class="la-cr__section-item ">Accounts</li>
                                <li class="la-cr__section-item">Course Enrollment and Lifetime Access</li>
                                <li class="la-cr__section-item">Payments, Credits, and Refunds</li>
                                <li class="la-cr__section-item">Content and Behavior Rules</li>
                                <li class="la-cr__section-item">LILA’s Rights to Content You Post</li>
                                <li class="la-cr__section-item">Using LILA at Your Own Risk</li>
                                <li class="la-cr__section-item">LILA’s Rights</li>
                                <li class="la-cr__section-item">Miscellaneous Legal Terms</li>
                                <li class="la-cr__section-item">Dispute Resolution</li>
                                <li class="la-cr__section-item">Updating These Terms</li>
                                <li class="la-cr__section-item">How to Contact Us</li>
                            </ol>
                        </div>


                        <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose text--black body-font la-anim__stagger-item">1. Accounts</h5>
                            ...
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                                ...
                                instructors who have shared account login credentials. You must notify us immediately
                        ...
                        <!-- Course Enrollment and Lifetime Access: Start -->
                        <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">2. Course Enrollment and Lifetime Access</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x  la-anim__A">
                                When you enroll in a course, you get a license from us to view it via LILA Services and no
                        ...
                        <!-- Course Enrollment and Lifetime Access: End -->

                        <!-- Payments, Credits, and Refunds:  Start -->
                        <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">3. Payments, Credits, and Refunds</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x  la-anim__A">
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">3.1 Pricing</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">3.2 Payments</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                                ...
                                in your country and to keep your payment information secure. Check out our Privacy Policy
                                for more details.
                            </p>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">3.3 Refunds and Cancellation of Subscription</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                                Once your subscription starts, you can't get a refund for any payments you've made. If you
                                don't wish to subscribe anymore, you can cancel your subscription. You will still have
                                access to the subscription until the end of the period you have paid for.
                        ...
                        <!-- Payments, Credits, and Refunds: End -->

                        <!-- Content and Behavior Rules:  Start -->
                        <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">4. Content and Behavior Rules</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x  la-anim__A">
                        ...
                        <!-- Content and Behavior Rules: End -->

                        <!-- LILA’s Rights to Content You Post:  Start -->
                        <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">5. LILA’s Rights to Content Your Post</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x  la-anim__A">
                        ...
                        <!-- LILA’s Rights to Content You Post: End -->

                        <!-- Using LILA at Your Own Risk:  Start -->
                        <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">6. Using LILA at Your Own Risk</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x  la-anim__A">
                        ...
                        <!-- Using LILA at Your Own Risk: End -->

                        <!-- LILA’s Rights:  Start -->
                        <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">7. LILA’s Rights</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x  la-anim__A">
                            ...
                            <div class="la-cr__section-para la-anim__stagger-item--x">
                                <p>You may not do any of the following while accessing or using the LILA platform and Services:</p>
                                
                                <ul class="la-cr__section-sublist ml-6 ml-md-10">
                                    <li class="la-cr__section-subitem pb-2">access, tamper with or use non-public areas of the platform (including content
                                        storage), LILA’s computer systems, or the technical delivery systems of LILA’s
                                        service providers.
                                    </li>
                                    <li class="la-cr__section-subitem pb-2">
                        ...
                        <!-- Miscellaneous Legal Terms:  Start -->
                        <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">8. Miscellaneous Legal Terms</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x  la-anim__A">
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">8.1 Binding Agreement</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">8.2 Disclaimers</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                                ...
                                language, <strong>the Services and their content are provided on an “as is” and “as available”
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">8.3 Limitation of Liability</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                                ...
                                from using our platform and Services. In legal, more complete language, <strong> to the extent
                                ...
                                incidental damages, so some of the above may not apply to you.</strong>
                            </p>

                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">8.4 Indemnification</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">8.5 Governing Law and Jurisdiction</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                                When these Terms mention <strong>“LILA,”</strong> they’re referring to the LILA entity that you’re contracting
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">8.6 Legal Actions and Notices</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                            ...
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                                ...
                                with your account or by you to notices@LILA.com).
                            </p>

                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">8.7 Relationship Between Us</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                                You and we agree that no joint venture, partnership, employment, contractor, or agency relationship exists between us.
                            </p>

                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">8.8 No Assignment</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                        ...
                        <!-- Miscellaneous Legal Terms: End -->

                        <!-- Dispute Resolution:  Start -->
                        <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">9. Dispute Resolution</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x  la-anim__A">
                            ...
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                                <strong>This Dispute Resolution section applies only if you live in the United States or Canada.</strong> <br/>
                                Most disputes can be resolved, so before bringing a formal legal case, please first try contacting our Support Team.
                            </p>

                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">9.1 Small Claims</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">9.2 Going to Arbitration</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">9.3 The Arbitration Process</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">9.4 No Class Actions</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                            ...
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">9.5 Changes</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x">
                                ...
                                email from the email address associated with your Account to notices@LILA.com, within 30
                        ...
                        <!-- Dispute Resolution: End -->
                         ...
                         <!-- Updating These Terms:  Start -->
                         <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">10. Updating These Terms</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x  la-anim__A">
                        ...
                        <!-- Updating These Terms: End -->

                         <!-- How to Contact Us:  Start -->
                         <div class="la-cr__section-subheading pt-6">
                            <h5 class="leading-loose  text--black body-font la-anim__stagger-item la-anim__A">11. How to Contact Us</h5>
                            <p class="la-cr__section-para la-anim__stagger-item--x  la-anim__A">
