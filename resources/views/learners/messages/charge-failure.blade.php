            ...
            <div class="col-12 d-block d-md-none">
                <div class="la-status__mobile-banner pt-8 pb-16">
                  <div class="la-status__mobile-img ">
                      <img src="/images/learners/status/failure.svg" data-src="/images/learners/status/failure.svg" class="lazy img-fluid mx-auto d-block" alt="Payment Failed" />
                  </div>
                </div>
            </div>
                  ...
                  <div class="la-status__info d-flex">
                      <div class="la-status__info-card ">
                          ...
                          <div class="la-status__info-btm">
                              ...
                              <div class="la-status__info-browse">
                                <a href="/cart">  <button class="la-btn la-payment__pay-btn la-status__info-cta py-3" role="button">Try Again</button> </a>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="la-status__info-banner d-none d-md-block">
                          <div class="la-status__info-showcase  ">
                              <img src="/images/learners/status/failure.svg" data-src="/images/learners/status/failure.svg" class="lazy d-block la-status__info-failureimg" alt="Payment Failed" />
                          </div>
                      </div>
                  </div>
            </div>
