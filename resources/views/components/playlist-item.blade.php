...
<div class="col-md-4 la-playlist__item mb-6 mb-md-10 la-anim__stagger-item" >
    <div class="la-playlist__item-top position-relative mb-4">
        <a class="la-course__inner-link"  href= "{{ '/playlist/'.$id }}" >
            <div class="la-playlist__option-more la-playlist__option-more--white position-absolute">
                <span class="dropdown-toggle d-inline-block la-course__menubtn p-2" id="playlist_menu" href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="la-icon la-icon--2xl icon icon-menu"></i>
                </span>
                <div class="la-cmenu dropdown-menu py-0">
                    <span class="dropdown-item la-cmenu__item d-inline-flex" onclick="editPlaylistPopup({{$id}}, '{{$courseName}}')"><i class="icon icon-edit la-icon la-icon--lg mr-4"></i>Edit Playlist</span>
                    <span class="dropdown-item la-cmenu__item d-inline-flex" onclick="location.href='/playlist-delete/{{$id}}'"><i class="icon icon-delete la-icon la-icon--lg mr-4"></i>Delete Playlist</span>
                    <span class="dropdown-item la-cmenu__item d-inline-flex" onclick="location.href='/playlist/{{$id}}'"><i class="icon icon-courses la-icon la-icon--lg mr-4"></i>See Courses</span>
                </div>
            </div>
