...
<div class="col-12 la-lcourse__card">
    <div class="la-lcourse position-relative">
        <div class="la-lcourse__inner">
            <!-- <div class="la-lcourse__inner-link stretched-link" id="course_card_link" role="button" href= "" > -->
            <div class="la-lcourse__inner-link">
                ...
                <div class="la-lcourse__overlay"> 
                    ...
                    <div class="la-lcourse__play position-relative text-center w-100  px-2">
                    ...
                    <div class="la-rtng__pg-rtng d-flex justify-content-end align-items-end mt-auto p-2">
                        @if($rating == 5)
                ...
                <div class="la-lcourse__info w-100 d-flex flex-column">
                    <div class="la-lcourse__info-inner w-100">
                        ...
                        <div class="d-flex justify-content-end position-relative w-100 mt-6">
