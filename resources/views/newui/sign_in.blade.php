            ...
            <div class="col-md-4 col-xl-4 m-0 p-0">
                ...
                <div class="login-form">
                    <div class="form-header">
                        ...
                        <h6>Get yourself a more secured Password!</h6>
                    </div>
                    <form method="POST" class="woocommerce-form woocommerce-form-login login"
                        ...
                        <div class="input-group chike-password-box">
                            ...
                            <input type="password" class="form-control" id="password-confirm"
                                ...
                                autocomplete="Enter Password" aria-describedby="Enter Password">
                            <a class="input-group-text togglePassword border-0"><i class="fa fa-eye"
                                    aria-hidden="true"></i></a>
                        </div>
                        </p>
                        ...
                        <p class="woocommerce-FormRow form-row text-center">
                            <button type="submit"
                                class="btn btn-sm btn-main-outline m-2 rounded w-50">{{ __('frontstaticword.ResetPassword') }}</button>
                        </p>
