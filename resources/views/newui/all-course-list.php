...
<head>
  ...
  <title>All Courses List | Coursehike</title>
  ...
  @media (max-width: 768px) {
    ...
    #chike-sidebar-filter-box{display: none;}
  }
  </style>
</head>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-xl-12">
            <h3>All Courses</h3>
             <button class="btn btn-sm btn-main-outline" id="chike-filter-btn"><i class="fa fa-filter" aria-hidden="true"></i></button>
            <hr>
          </div>
             ...
             <div class="cart-collaterals mb-3">
              ...
              <div class="cart-collaterals mt-4">
                  <div class="cart_totals">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="wishlist">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="course-grid tooltip-style bg-white hover-shadow">
                        ...
                        <div class="course-content">
                            ...
                            <h3 class="course-title mb-10"> <a href="#">SQL-Data Analysis: Crash Course</a> </h3>
                            <div class="course-footer mt-10 d-flex align-items-center justify-content-between ">
