...
<head>
  ...
  <title>Sign Up | Coursehike</title>
                        ...
                        <form class="woocommerce-form woocommerce-form-login login" method="post">
                           <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                <div class="input-group flex-nowrap chike-input-group-box">
                                  ...
                                  <input type="text" class="form-control" placeholder="*Enter Full Name" aria-label="Enter Full Name" aria-describedby="addon-wrapping">
                                </div>
                            </p>
                            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                <div class="input-group flex-nowrap chike-input-group-box">
                            ...
                            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                <div class="chike-input-group-box pb-0">
                                  <input type="text" class="form-control" name="contactno" id="telephone" autocomplete="Enter Mobile Number" placeholder="*Enter Mobile Number" aria-describedby="Enter Mobile Number">
                                </div>
                            </p>
                            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                <div class="input-group flex-nowrap chike-input-group-box pb-0">
                                  <span class="input-group-text" id="addon-wrapping"><i class="fa fa-birthday-cake" aria-hidden="true"></i></span>
                                  <input type="date" class="form-control" placeholder="*Enter date of birth" aria-label="Enter date of birth" aria-describedby="addon-wrapping">
                                </div>
                            </p>
        
                            <p class="woocommerce-FormRow form-row text-center">
                                <button type="submit" class="btn btn-sm btn-main-outline m-2 rounded w-50" name="register" value="LOGIN">Sign Up</button>
                            </p>
