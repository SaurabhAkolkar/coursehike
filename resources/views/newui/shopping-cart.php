...
<head>
  ...
  <title>Shopping Cart | Coursehike</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-xl-8">
            <h2><img src="assets/images/course-overview/chike-shopping cart-icon.svg" alt="Shopping Cart" class="img-fluid chike-shopping-cart-icon" width="25" height="25">Shopping Cart</h2>
            <hr>
            <div class="row">
              <div class="col-lg-10 col-xl-10 col-md-10">
                <span><strong>2 course</strong></span>
              </div>
            ...
            <div class="row mt-4 mb-4">
              ...
              <div class="col-lg-2 col-xl-2 col-md-2">
                <h6 class="chike-course-price-title">$2000</h6>
              </div>
            </div>
            <!-- /item -->
                  ...
                  <div class="cart_totals">
                      ...
                      <table cellspacing="0" class="shop_table shop_table_responsive">
                          ...
                          <tr class="cart-subtotal">
                              <th>Subtotal</th>
                              <td data-title="Subtotal"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>6998</span></td>
                          </tr>
                          <tr class="cart-subtotal">
                            <th><span>50% off</span></th>
                            <td data-title="Subtotal"><span class="woocommerce-Price-amount amount text-decoration-line-through"><span class="woocommerce-Price-currencySymbol">$</span>6998</span></td>
                          </tr>
                          <tr class="order-total">
                              <th>Total</th>
                              <td data-title="Total"><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>5998</span></strong> </td>
                          </tr>
                          </tbody>
                      </table>
