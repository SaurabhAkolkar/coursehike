...
@section('seo_content')
    <title>Courses | Best Online Courses | LILA</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-xl-12">
                <h3>All Courses</h3>
                {{-- <button class="btn btn-sm btn-main-outline" id="chike-filter-btn">
                ...
                <div class="cart-collaterals">
                    <div class="cart_totals">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" disabled="disabled" value=""
                                id="alllevels">
                ...
                <div class="course-top-wrap mb-4">
                    <div class="fuild-container">
                        <div class="row align-items-center">
                            <div class="col-lg-9">
                                <p class="chike-showing-results-title">Showing {{ count($courses) }} results</p>
                            </div>
                            <div class="col-lg-3">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="course-grid tooltip-style bg-white hover-shadow">
                                ...
                                <div class="course-content">
                                    ...
                                    <div
                                        ...
                                        <span class="duration"><i
                                                class="far fa-clock me-2"></i>{{ $course->duration }}</span>
                                ...
                                <div class="course-footer text-center border p-3">
                                    <a href="{{ route("buynow",$course->id)  }}" class="btn btn-main-outline btn-radius btn-sm">Buy Now <i
