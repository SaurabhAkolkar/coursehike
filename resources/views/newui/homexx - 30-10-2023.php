...
<head>
  ...
  .course-page-header {
        ...
        background: #F4F5F8;
        position: relative;
        background: url(./assets/images/home-page/top-home-page-banner.jpg);
...
<body id="top-header" class="bg-grey">
            ...
            <div class="container-xxl">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="header-btn d-none d-xl-block">
                        ...
                        <a href="#" class="btn btn-main-2 btn-sm-2 rounded-pill">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--  Course style 1 -->
    <section class="course-wrapper bg-grey" style="padding: 30px 0px 60px;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-12">
                    <div class="section-heading mb-30 text-left">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="course-grid bg-shadow tooltip-style">
                        ...
                        <div class="course-hover-content">
                            ...
                            <div class="course-footer mb-10 mt-10 d-flex align-items-center justify-content-between ">
                                <span class="students"><i class="far fa-language me-2"></i> Hindi</span>
                                <span class="lessons"><i class="far fa-play-circle me-2"></i>26 Lessons</span>
                                <span class="duration"><i class="far fa-clock me-2"></i>12 Hourse</span>
                            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="text-center">
                        <a href="#" class="text-style2 text-decoration-underline fw-bold chike-explore-more-title">Explore More</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="instructors section-padding bg-white">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 pe-5">
                    <div class="section-heading">
                        <h2 class="font-lg mb-20 chike-title-color-blue">Why Choose Us</h2>
                        <p class="mb-30">Share your expertise with the world! Become an instructor on CourseHike and create high-quality e-learning courses that reach a global audience. Apply today and join our community of educators and creators.</p>
                        ...
                        <ul class="list-item mb-40">
                            ...
                            <li><i class="fa fa-check-circle text-success"></i><h5>Learn from industry experts</h5></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row align-items-center justify-content-lg-center">
                <div class="col-xl-12 col-lg-12">
                    <div class="section-heading mt-4 mt-lg-0 text-center">
                        ...
                        <a href="#" class="btn btn-main btn-radius m-2" >Join Now</a> 
                        <a href="#" class="btn btn-main-outline btn-radius m-2" >Learn More</a>
                    </div>
                </div>
            </div>
        </div>
