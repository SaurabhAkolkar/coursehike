	            ...
	            <div class="col-xl-9 col-lg-8">
	                ...
	                <div class="profile-info-block">
	                    ...
	                    <div class="row">
	                        <div class="col-lg-6">
	                            <div class="form-group">
	                                ...
	                                <input type="text" id="name" name="fname" class="form-control" placeholder="{{ __('frontstaticword.EnterFirstName') }}" value="{{ $orders->fname }}">
	                            </div>
	                            <div class="form-group">
	                        ...
	                        <div class="col-lg-6">
	                            <div class="form-group">
	                                ...
	                                <input type="text" id="lname" name="lname" class="form-control" placeholder="{{ __('frontstaticword.EnterLastName') }}" value="{{ $orders->lname }}">
	                            </div>
	                            <div class="form-group">
	                                <label for="mobile">{{ __('frontstaticword.Mobile') }}</label>
	                                <input type="text" name="mobile" id="mobile" value="{{ $orders->mobile }}" class="form-control" placeholder="{{ __('frontstaticword.EnterMobileNo') }}">
	                            </div>
	                            <div class="form-group">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <textarea id="address" name="address" class="form-control" placeholder="{{ __('frontstaticword.EnteryourAddress') }}" value="">{{ $orders->address }}</textarea>
	                    </div>
	                    <br>
	                    ...
	                    <div class="form-group">
	                        ...
	                        <textarea id="detail" name="detail" class="form-control" placeholder="{{ __('frontstaticword.Enteryourdetails') }}" value="">{{ $orders->detail }}</textarea>
	                    </div>
	                    <br>
