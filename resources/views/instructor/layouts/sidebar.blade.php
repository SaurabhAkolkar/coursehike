        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="{{ Nav::isRoute('instructor.index') }}">
            <a href="{{route('instructor.index')}}">
              ...
              <i class="la-icon la-icon--lg icon-dashboard mr-4"></i>
          ...
          <li class="{{ Nav::isResource('category') }} {{ Nav::isResource('subcategory') }} {{ Nav::isResource('childcategory') }} {{ Nav::isResource('course') }} {{ Nav::isResource('courselang') }} treeview">
            ...
            <ul class="treeview-menu">
              <li class="{{ Nav::isResource('category') }} {{ Nav::isResource('subcategory') }} {{ Nav::isResource('childcategory') }} {{ Nav::isResource('course') }} {{ Nav::isResource('courselang') }} treeview">
                  ...
                  <a href="#"> <i class="la-icon la-icon--lg icon-categories mr-4"></i>{{ __('adminstaticword.Category') }}
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  ...
                  <li class="{{ Nav::isResource('course') }}"><a href="{{url('course')}}"> <i class="la-icon la-icon--lg icon-courses mr-4"></i><span>{{ __('adminstaticword.Course') }}</span></a></li>

                  <li class="{{ Nav::isResource('courselang') }}"><a href="{{url('courselang')}}">  <i class="la-icon la-icon--lg icon-course-language mr-4"></i><span> {{ __('adminstaticword.Course') }} {{ __('adminstaticword.Language') }}</span></a></li>
          ...
          <li class="">
            <a href="/requests">
              <i class="la-icon la-icon--lg icon-request mr-4"></i>
              <span>Requests</span>
            </a>
          </li>
          ...
          <li class="{{ Nav::isResource('pending.payout') }} {{ Nav::isRoute('admin.completed') }} treeview">
            <a href="#">
              <i class="la-icon la-icon--lg icon-revenue mr-4"></i> {{ __('adminstaticword.MyRevenue') }}
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>                            
          ...
          <li class="{{ Nav::isResource('instructor.pay') }}"><a href="{{route('instructor.pay')}}"><i class="la-icon la-icon--lg icon-revenue mr-4"></i> <span>{{ __('adminstaticword.PayoutSettings') }}</span></a></li>

          @endif
          
          <li class="{{ Nav::isResource('instructorquestion') }} {{ Nav::isResource('instructoranswer') }} treeview">
            <a href="#">
              <i class="la-icon la-icon--lg icon-faq mr-4"></i> {{ __('adminstaticword.Faq') }} 
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>                            
