            ...
            <div class="col-md-4 col-xl-4 m-0 p-0">
                ...
                <div class="login-form">
                    <div class="form-header">
                        ...
                        <h6>Provide email id to receive password reset link</h6>
                    </div>
                    <form method="POST" action="/reset-passoword-mail">
                        ...
                        <div class="input-group flex-nowrap chike-email-box">
                            ...
                            <input id="email" type="email" class="form-control" placeholder="Enter Your E-Mail"
                                name="email" style="border:none" value="{{ old('email') }}" required aria-label="Enter Your E-Mail"
                        ...
                        <p class="woocommerce-FormRow form-row text-center">
                            <button type="submit" class="btn btn-sm btn-main-outline m-2 rounded w-50">Send
                                Link</button>
                        </p>
                            ...
                            <div class="chike-login-share align-items-center mb-3">
                                <ul class="social-icon">
                                    <li class="chike-social-icon-box">
                                        <a href="{{ url('/auth/linkedin') }}"><img
                                                src="{{ asset('assets/images/login/chike-linkedin-icon.svg')}}" class="img-fluid"
                                                alt="linkedin" width="20" height="20"></a>
                                    </li>
                                    <li class="chike-social-icon-box">
                                        <a href="{{ url('/auth/facebook') }}"><img
                                                src="{{ asset('assets/images/login/chike-facebook-icon.svg')}}" class="img-fluid"
                                                alt="facebook" width="20" height="20"></a>
                                    </li>
                                    <li class="chiksocial-icon-box">
                                        <a hhref="{{ url('/auth/google') }}"><img
                                                src="{{ asset('assets/images/login/chike-google-icon.svg')}}" class="img-fluid"
                                                alt="google" width="20" height="20"></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="woocommerce-register mb-2">
                                Don't have an account yet? <a class="text-decoration-underline"
                                    style="color:#3479E2;font-weight: 700;" href="{{ route('register') }}"
                                    title="sign-up"> {{ __('frontstaticword.Signup') }} </a>
                            </div>
