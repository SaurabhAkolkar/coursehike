...
<section id="signup" class="signup-block-main-block">
    <div class="container-fluid">
        <div class="col-md-8">
            <div class="signup-slider-wrap">
                <div class="signup-slider-item">
                    ...
                    <div class="signin-social d-inline-flex mx-auto">
                        @if($gsetting->fb_login_enable == 1)  
                            <div class="signin-link">
                                <a href="{{ url('/auth/facebook') }}" target="_blank" title="facebook" class="btn btn-info rounded-circle" title="Facebook"><i class="m-0 fa fa-facebook"></i>
                        ...
                        @if($gsetting->google_login_enable == 1)
                            <div class="signin-link google">
                                <a href="{{ url('/auth/google') }}" target="_blank" title="google" class="btn btn-white rounded-circle" title="google"><i class="m-0 fab fa-google-plus-g"></i>
                        ...
                        @if($gsetting->linkedin_enable == 1)
                            <div class="signin-link linkedin-button">
                                <a href="{{ url('/auth/linkedin') }}" target="_blank" title="linkedin" class="btn btn-info rounded-circle" title="Linkedin"><i class="m-0 fab fa-linkedin"></i>
