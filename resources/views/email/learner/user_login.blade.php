        ...
        <table width="600" cellspacing="0" cellpadding="0" style="width:600px; margin:0 auto;border:0;background-color:#F5F4F0" >
            ...
            <tr>
                <td align="center" width="600" colspan="2" >
                    <span style="color:#FAC216;font-family:Verdana;font-size:56px;font-weight:900;text-transform:uppercase;">New Login Detected</span>
                </td>
            </tr>
                    ...
                    <table width="500" align="center">
                        ...
                        <tr>
                            <td align="center" style="padding:25px 20px 5px 20px">
                                 <span style="font-size:14px;color:#010101;font-weight:400;">A new login is detected on our platform using your email.</span>
                            </td>
                        </tr>
