    ...
    <section class="sidebar">
      ...
      @if(Auth::User()->role == "admin")
        <ul class="sidebar-menu" data-widget="tree">
         ...
         <li class="{{ Nav::isResource('announcement') }}"><a href="{{url('announcement')}}" class="d-flex align-items-center"><i class="la-icon la-icon--lg icon-announcement mr-4" aria-hidden="true"></i><span>{{ __('adminstaticword.Announcement') }}s</span></a></li>
