    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          ...
          <img src="{{ Auth::User()->user_img}}" class="img-circle rounded-circle img-fluid d-block" alt="User Image">
      ...
      @if(Auth::User()->role == "admin")
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="{{ Nav::isRoute('user.index') }} {{ Nav::isRoute('user.add') }} {{ Nav::isRoute('create.subscription') }}  {{ Nav::isRoute('user.edit') }} {{ Nav::isResource('user/subscriptions/add-course') }}"><a href="{{route('user.index')}}" class="d-flex align-items-center"><i class="la-icon la-icon--lg icon-users  mr-4" aria-hidden="true"></i><span>{{ __('adminstaticword.Users') }}</span></a></li>
