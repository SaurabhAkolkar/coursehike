  ...
  <div class="row">
    <div class="col-12">
      <div class="box box-primary">
        <h3 class="la-admin__section-title ml-3"> {{ __('adminstaticword.Add') }} {{ __('adminstaticword.Slider') }}</h3>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="la-admin__preview">
                    <label class="la-admin__preview-label" for="exampleInputSlug"> {{ __('adminstaticword.Image') }}:<sup class="redstar">*</sup></label>
                    <br>
                    <div class="la-admin__preview-img la-admin__course-imgvid" >
                      ...
                      <input type="file" name="image" id="image" class="inputfile inputfile-1 la-admin__preview-input"  />
