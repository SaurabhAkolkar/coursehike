              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  ...
                  <li class="tg-list-item">
                    <input class="la-admin__toggle-switch" id="cb10" type="checkbox" {{ $find->status==1 ? 'checked' : '' }}>
                    <label class="la-admin__toggle-label" data-tg-off="Deactive" data-tg-on="Active" for="cb10"></label>
                  </li>
