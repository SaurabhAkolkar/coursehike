...
<div class="la-admin__section-content">
    ...
    <div class="row">
        <div class="col-6 col-md-4">
          <!-- small box -->
            ...
            <div class="small-box"> 
              ...
              <span class="small-box-footer"><!-- <?php echo e(__('adminstaticword.Moreinfo')); ?> --> 
        ...
        <div class="col-6  col-md-4">
          <!-- small box -->
          <a href="href="<?php echo e(url('category')); ?>"" >
            <div class="small-box">
              <div class="inner">
              <div class="icon py-2">
        ...
        <div class="col-6 col-md-4 pt-8">
          <!-- small box -->
            <a  href="<?php echo e(route('all.instructor')); ?>" >
              <div class="small-box">
                <div class="inner">
                  <div class="icon">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\lila-laravel\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>