  ...
  <div class="row">
    <div class="col-12">
        <div class="text-right">
          <a data-toggle="modal" data-target="#myModaltopic" href="#" class="btn btn-info btn-sm">+ <?php echo e(__('adminstaticword.Add')); ?> <?php echo e(__('adminstaticword.Question')); ?></a>
        </div>
        <br/>
          ...
          <tr>
            ...
            <td><?php echo $i;?></td>
              ...
              <td class="d-flex justify-content-between align-items-center">
                <a class="" title="Add Question" href="<?php echo e(route('answersheet', $topic->id)); ?>"> Delete Answer</a>

                <a class="" title="Add Question" href="<?php echo e(route('questions.show', $topic->id)); ?>"> <?php echo e(__('adminstaticword.Add')); ?> <?php echo e(__('adminstaticword.Question')); ?></a>
             
                <a href="<?php echo e(url('admin/quiztopic/'.$topic->id)); ?>" title="Edit" class="btn btn-success btn-sm"><i class="la-icon la-icon--lg icon-edit"></i></a>
            ...
            <div class="modal-body">
              <form id="demo-form2" method="post" action="<?php echo e(url('admin/quiztopic/')); ?>" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="box-footer">
                  <button type="submit" value="Add Answer" class="btn btn-md col-md-4 btn-primary"> <?php echo e(__('adminstaticword.Save')); ?></button>
                </div>
...
<?php /**PATH E:\lila-laravel\resources\views/admin/course/quiztopic/index.blade.php ENDPATH**/ ?>