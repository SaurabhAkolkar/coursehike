                    ...
                    <table width="500" align="center" >
                        ...
                        <tr>
                            <td align="center"  colspan="1"  >
                                <a href="<?php echo e(env('APP_URL')); ?>/password/reset/<?php echo e($token); ?>?email=<?php echo e($email); ?>"  style="background:#7600DA; font-size:12px;color:#fff;padding:10px 50px;border:none;font-weight:300;border-radius:5px;">Click Here</a>
                            </td>
                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\lila-laravel\resources\views/email/learner/password-recovery.blade.php ENDPATH**/ ?>