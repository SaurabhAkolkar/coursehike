      ...
      <div class="col-12">
          <div class="la-admin__invoice-details d-flex justify-content-between py-5">
              <div class="la-admin__cust-info">
                  <h6>SOLD TO</h6> 
                  <div class="la-admin__cust-name"> <?php echo e($show->courses->user['fname']); ?> </div>
                  <div class="la-admin__cust-address">Address: <?php echo e($show->courses->user['address']); ?><br>
                  ...
                  <a class="la-admin__cust-mobile d-flex align-items-center" href="tel: <?php echo e($show->courses->user['mobile']); ?>"><span class="la-icon--xl icon-contact-number"></span> <span class="pl-2"> +<?php echo e($show->courses->user['mobile']); ?> </span></a> 
                  <a class="la-admin__cust-mail d-flex align-items-center" href="mailto: <?php echo e($show->courses->user['email']); ?>"><span class="la-icon--xl icon-mail-id"></span> <span class="pl-2"> <?php echo e($show->courses->user['email']); ?> </span></a>
              </div>
              ...
              <div class="la-admin__cust-invoice text-right">
                ...
                <div>
                  ...
                  <span class="la-admin__invoice-id"><?php echo e($show['order_id']); ?></span>
                </div>
              </div>
          </div>
      </div>
...
<?php $component = $__env->getContainer()->make(App\View\Components\AdminInvoice::class, ['img' => $show->courses['preview_image'],'course' => $show->courses['title'],'profile' => $show->courses->user['fname'],'price' => $show['total_amount']]); ?>
...
<?php endif; ?>
              ...
              <?php if($show->bundle_id != NULL): ?>
                <ul class="la-admin__invoice-list">
                  ...
                  <?php $__currentLoopData = $show->bundle_course_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bundle_course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php
                        $coursess = App\Course::where('id', $bundle_course)->first();
                      ?>

                         <?php if (isset($component)) { $__componentOriginal3963dbe08b28fe98d639a0d105e12b6d9f7ac150 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\AdminInvoice::class, ['img' => $coursess->preview_image,'course' => $coursess->title,'profile' => $item->profile,'price' => $item->price]); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
<?php if (isset($__componentOriginal3963dbe08b28fe98d639a0d105e12b6d9f7ac150)): ?>
...
<?php endif; ?>
              ...
              <div class="la-admin__invoice-total d-flex justify-content-end">
                  ...
                  <p class="la-admin__total-price" > $ <span><?php echo e($show['total_amount']); ?></span> </p>
              </div>
          </div>
      </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\lila-laravel\resources\views/admin/order/view.blade.php ENDPATH**/ ?>