          ...
          <div class="la-header__menu d-inline-flex align-items-center position-relative">
            ...
            <div class="la-header__menu-item d-none d-md-block">
              ...
              <div class="la-gsearch  mb-0" >
                <form class="form-inline mb-0" action="<?php echo e(url('/search-course/')); ?>" method="get">
                  <div class="form-group la-header__gsearch" >
                    <input class="la-gsearch__input form-control text-md px-0 la-header__gsearch-input" type="text" name="course_name" value="<?php echo e(isset($search_input)?$search_input:''); ?>" placeholder="Search Courses and Classes..." required>
                  </div>
        ...
        <div class="la-header__menu d-inline-flex align-items-center">
          ...
          <div class="la-header__menu-item d-none d-md-block">
            ...
            <div class="la-gsearch  mb-0" >
              <form class="form-inline mb-0" action="<?php echo e(url('/search-course/')); ?>" method="get">
                  <div class="form-group la-header__gsearch" >
                    <input class="la-gsearch__input form-control text-md pr-0 la-header__gsearch-input" type="text" name="course_name" value="<?php echo e(isset($search_input)?$search_input:''); ?>" placeholder="Search Courses and Classes..." required>
                  </div>
...
<?php endif; ?>
  <!-- Header: End--><?php /**PATH E:\lila-laravel\resources\views/learners/pages/header.blade.php ENDPATH**/ ?>