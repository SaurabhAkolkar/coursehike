<?php $__env->startSection('title', 'Course Unpublish Requests - Admin'); ?>
  ...
  <div class="row">
    <div class="col-12">
      <div class="box box-primary">
          <h3 class="la-admin__section-title ml-2"><?php echo e(__('adminstaticword.Course')); ?> Unpublish Request</h3>
...
<?php echo $__env->make('admin/layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\lila-laravel\resources\views/admin/course_review/unpublishRequest.blade.php ENDPATH**/ ?>