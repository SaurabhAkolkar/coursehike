<div class="card la-course__tiles position-relative w-100 d-flex flex-row ">
    ...
    <div class="col-5 h-100 la-course__tile-content d-block px-3 pt-2 la-anim__fade-in-bottom">
        ...
        <p class="la-course__tile-creator text-xs m-0"> <?php echo e($name); ?> </p>

        <div class="la-course__tile-rating pt-3">
            <div class="la-course__tile-indicator text-xs"> <?php echo e($progress); ?>% <span>Completed</span></div>
...
</div><?php /**PATH E:\lila-laravel\resources\views/components/last-viewed.blade.php ENDPATH**/ ?>