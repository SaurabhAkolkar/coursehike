                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-4 la-entry__interest la-anim__stagger-item--x">
                      <div class="la-entry__interest-inner position-relative d-flex align-items-end">
                        <span class="la-entry__interest-thumbnail z-0" role="button" onclick="addToInterest(<?php echo e($c->id); ?>)" id="interest_span_<?php echo e($c->id); ?>">
                          <img class="img-fluid" src="<?php echo e($c->image); ?>" alt="" />
                        </span>
                      </div>
                      <div class="la-entry__interest-name pt-1 text-capitalize"><?php echo e($c->title); ?></div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('learners.layouts.intro', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\lila-laravel\resources\views/learners/auth/interests.blade.php ENDPATH**/ ?>