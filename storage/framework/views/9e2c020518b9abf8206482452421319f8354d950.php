...
<head>
    ...
    <?php echo $__env->yieldContent('headAssets'); ?>
...
<body>
    <div class="la-app__inner">
        ...
        <main class="la-main">
            ...
            <?php echo $__env->make('learners.layouts.popups', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>               
        </main>
    </div>

    <?php echo $__env->make('learners.pages.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(('/js/scripts/main.js')); ?>"></script>
    
</body>
</html><?php /**PATH C:\xampp\htdocs\lila-laravel\resources\views/learners/layouts/app.blade.php ENDPATH**/ ?>