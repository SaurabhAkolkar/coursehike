              ...
              <div class="col-12 col-md-6 col-lg px-0">
                <div class="la-ctabs__certificate d-flex">
                  ...
                  <div class="la-ctabs__certificate-desc la-anim__stagger-item--x">
                    <div class="la-ctabs__certificate-title text-md-lg  text-uppercase"><?php echo e($course->title); ?></div><a class="la-ctabs__certificate-file text-sm" href=""><?php echo e($course->title); ?>.pdf</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class=" la-anim__wrap">
                  ...
                  <div class="la-rtng__wrapper d-flex flex-column flex-md-row justify-content-between">
                    <div class="la-rtng__overall text-left text-md-center la-anim__stagger-item">
                      <div class="la-rtng__total body-font text-5xl mx-4 mx-md-0 px-5 px-md-0"><?php echo e($average_rating); ?></div>
                ...
                <div class="la-lcreviews__inner">
                  <div class="la-lcreviews__wrapper d-flex flex-column flex-md-row justify-content-between">
                    <div class="la-lcreviews__prfle d-inline-flex align-items-center la-anim__wrap">
                      ...
                      <img class="img-fluid rounded-circle d-block" src="<?php echo e($review->user->user_img); ?>" alt="<?php echo e($review->user->fname); ?>"></div>
                      <div class="la-lcreviews__prfle-info ml-4 la-anim__stagger-item--x">
                        ...
                        <h4 class="la-lcreviews__uname text-md text-md-lg text-uppercase "><?php echo e($review->user->fname.' '.$review->user->lname); ?></h4>
                      </div>
                    </div>
                    <div class="la-lcreviews__content w-100 la-anim__wrap">
                      <div class="la-lcreviews__ratings la-anim__stagger-item--x"> <?php for($couter=1 ; $couter <= $review->rating; $couter++): ?><span class="la-icon--xl icon-star la-rtng__fill"></span><?php endfor; ?>  <?php for($couter=1 ; $couter <= 5 - $review->rating; $couter++): ?><span class="la-icon--xl icon-star la-rtng__unfill"></span><?php endfor; ?></div>
                      <div class="la-lcreviews__comment text-md la-anim__stagger-item--x"><?php echo e($review->review); ?></div>
                    </div>
