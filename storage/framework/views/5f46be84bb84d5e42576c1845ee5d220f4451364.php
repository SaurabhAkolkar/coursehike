        ...
        <div class="box box-primary">
          <div class="panel panel-sum">
            <div class="modal-body">
              <form id="demo-form2" method="post" action="<?php echo e(route('coursechapter.store')); ?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label for="exampleInputTit1e"><?php echo e(__('adminstaticword.ClassName')); ?>:<span class="redstar">*</span> </label>
                ...
                <div class="box-footer">
                 <button type="submit" class="btn btn-md col-md-4 btn-primary"><?php echo e(__('adminstaticword.Submit')); ?></button>
                </div>
...
<?php $__env->stopSection(); ?><?php /**PATH E:\lila-laravel\resources\views/admin/course/coursechapter/index.blade.php ENDPATH**/ ?>