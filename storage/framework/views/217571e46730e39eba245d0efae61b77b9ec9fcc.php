<div class="la-cart__bill la-anim__stagger-item--x">
    ...
    <div class="la-cart__bill-items mb-4">
        <div class="la-cart__bill-item d-flex justify-content-between mb-2 ">
            ...
            <div class="la-cart__bill-amount">$ <?php echo e($totalAmount); ?></div>
        </div>
        ...
        <div class="la-cart__bill-item d-flex justify-content-between mb-2">
            ...
            <div class="la-cart__bill-amount">$ <?php echo e($offerAmount); ?></div>
        </div>
        <div class="la-cart__bill-item d-flex justify-content-between mb-2 ">
 ...
 <div class="modal fade la-cart__bill-modal" id="cartCoupons">
            ...
            <!-- Apply Coupon Popup: End --><?php /**PATH C:\xampp\htdocs\lila-laravel\resources\views/components/cart-total.blade.php ENDPATH**/ ?>