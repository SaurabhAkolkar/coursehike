  ...
  <div class="row">
    <div class="col-md-12">
        <div class="text-right">
            <a data-toggle="modal" data-target="#myModalabc" href="#" class="btn btn-info btn-sm">+ <?php echo e(__('adminstaticword.AddRelatedCourse')); ?></a>
        </div>
        <br/>
          ...
          <tbody>
            ...
            <?php $__currentLoopData = $relatedcourse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                  <a class="btn btn-success btn-sm" href="<?php echo e(url('relatedcourse/'.$cat->id)); ?>"><i class="la-icon la-icon--lg icon-edit"></i></a>
                </td>
                <td>
...
<?php /**PATH E:\lila-laravel\resources\views/admin/course/relatedcourse/index.blade.php ENDPATH**/ ?>