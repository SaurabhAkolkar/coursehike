                        ...
                        <div class="row">
                          <div class="col-6 la-anim__stagger-item--x">
                            <div class="la-form__img-wrap">
                              ...
                              <div class="la-form__img d-inline-block d-flex justify-content-center content-fit"><img src="<?php echo e(Auth::user()->user_img); ?>" id="user_image" alt="" class="mw-100 mh-100"></div>
                            </div>
                          </div>
                          <div class="col-6 la-anim__stagger-item--x">
                            <div class="la-form__img-wrap">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 la-anim__stagger-item--x">
                                    <div class="la-form__input-wrap">
                                      ...
                                      <input class="la-form__input" type="text" value="<?php echo e(Auth::user()->fname); ?>" name="first_name" placeholder="Enter your First Name">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 la-anim__stagger-item--x">
                                    <div class="la-form__input-wrap">
                                      ...
                                      <input class="la-form__input" type="text" value="<?php echo e(Auth::user()->lname); ?>" name="last_name" placeholder="Enter your Last Name">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 la-anim__stagger-item--x">
                                    <div class="la-form__input-wrap">
                                      ...
                                      <input class="la-form__input" type="email" value="<?php echo e(Auth::user()->email); ?>" name="email" placeholder="Enter your Email ID">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 la-anim__stagger-item--x">
                                    <div class="la-form__input-wrap">
                                      ...
                                      <input class="la-form__input" type="tel" value="<?php echo e(Auth::user()->mobile); ?>" name="mobile" placeholder="Enter your Mobile Number">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 la-anim__stagger-item--x">
                                    ...
                                    <input class="la-form__input" type="date" value="<?php echo e(Auth::user()->dob); ?>" name="dob" placeholder="Enter your Date of Birth" min='1899-01-01' max='2000-01-01'>
                                      <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                      ...
                      <div class="la-form__input-wrap">
                        ...
                        <div class="d-flex pt-2">
                                        <div class="la-form__radio-wrap mr-5">
                                          <input class="la-form__radio d-none" type="radio" value="male" name="gender" id="male" <?php if(Auth::user()->gender == "male"): ?>checked <?php endif; ?>>
                                        ...
                                        <div class="la-form__radio-wrap mr-5">
                                          <input class="la-form__radio d-none" type="radio" value="female" name="gender" id="female" <?php if(Auth::user()->gender == "female"): ?>checked <?php endif; ?>>
                                        ...
                                        <div class="la-form__radio-wrap mr-5">
                                          <input class="la-form__radio d-none" type="radio" value="Other" name="gender" id="Other" <?php if(Auth::user()->gender == "Other"): ?>checked <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12 la-anim__stagger-item--x">
                                    <div class="la-form__input-wrap">
                                      ...
                                      <input class="la-form__input" type="text" value="<?php if(Auth::user()->address==""): ?><?php echo e(old('address')); ?><?php else: ?><?php echo e(Auth::user()->address); ?><?php endif; ?>" name="address" placeholder="Enter your Residential Address">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 la-anim__stagger-item--x">
                                    <div class="la-form__input-wrap">
                                      ...
                                      <!-- <input class="la-form__input" type="text" value="<?php echo e(Auth::user()->country_id); ?>" name="country" placeholder="India"> -->
                                      <select class="la-form__input" name="country" id="country_id">
                                        ...
                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php if(Auth::user()->country_id == $key): ?> selected <?php endif; ?>>
                                                <?php echo e($value); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 la-anim__stagger-item--x">
                                    <div class="la-form__input-wrap">
                                      ...
                                      <!-- <input class="la-form__input" type="text" value="<?php echo e(Auth::user()->state_id); ?>" name="state" placeholder="India"> -->
                                      <select class="la-form__input" name="state" id="state_id">
                                        <option disabled selected>Select State</option>
                                          <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <option value="<?php echo e($key); ?>" <?php if(Auth::user()->state_id == $key): ?> selected <?php endif; ?>>
                                                  <?php echo e($value); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 la-anim__stagger-item--x">
                                    <div class="la-form__input-wrap">
                                      ...
                                      <!-- <input class="la-form__input" type="text" value="<?php echo e(Auth::user()->city_id); ?>" name="city" placeholder="India"> -->
                                      <select class="la-form__input" name="city" id="city_id">
                                        ...
                                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>"  <?php if(Auth::user()->city_id == $key): ?> selected <?php endif; ?>>
                                                <?php echo e($value); ?>
            ...
            <section class="la-section la-profile__update-passwrod la-profile__form la-anim__wrap">
              <div class="la-profile__form-inner ">
                ...
                <div class="collapse " id="passwordCollapse">
                  <form class="la-password__update-content" id="change_password_form" method="Post" action="<?php echo e(route('update.password')); ?>" name = "change_password_form">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="la-form__input-wrap">
...
<script>
      ...
      $('#state_id').change(function() {
        ...
        let urlLike = '<?php echo e(url('country/gcity')); ?>';
        if(cat_id){
          $.ajax({
            headers: {
      ...
      $('#country_id').change(function() {
        ...
        let urlLike = '<?php echo e(url('country/gstate')); ?>';
        if(cat_id){
          $.ajax({
            headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('learners.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lila-laravel\resources\views/learners/pages/profile.blade.php ENDPATH**/ ?>