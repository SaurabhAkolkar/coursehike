                ...
                <div class="col-md-12 text-center">
                    <div class="la-cert__main">
                            ...
                            <div class="la-cert__info" style="padding:20px 0">
                                ...
                                <h1 class="la-cert__learner pt-3" style="font-size:64px;border-bottom:2px solid #FFC516;margin:0 35px;"><?php echo e($learner_name); ?></h1>
                                <div class="la-cert__desc" style="color:#252525;font-size:16px;letter-spacing:1px;padding-top:30px;">
                                    This is to certify that <strong>' <?php echo e($learner_name); ?> '</strong> successfully completed XX hours of 
                                    <strong>' <?php echo e($course->title); ?> '</strong> course on '<?php echo e($date); ?>'.
                                </div>
                            </div>

                            <div class="la-cert__sign  px-5" style="padding-top:120px">                            
                                <div class="float-left" style="border-top:1px solid #FFC516;"><?php echo e($mentor); ?></div>   
...
</html><?php /**PATH E:\lila-laravel\resources\views/learners/pages/courseCertificate.blade.php ENDPATH**/ ?>