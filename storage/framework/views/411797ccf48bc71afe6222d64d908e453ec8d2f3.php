    ...
    <div class="modal fade la-playlist__modal" id="add_to_playlist_modal">
                    ...
                    <div class="modal-content la-playlist__modal-content">
                        ...
                        <div class="modal-body la-playlist__modal-body">
                            ...
                            <form action="<?php echo e(route('add.to.playlist')); ?>" id="add_to_playlist_form" method="post">
                                <?php echo csrf_field(); ?>
                            ...
                            <div class="la-playlist__modal-list list-group list-group-flush  playlist_div_height" id="user_playlists" >
                                <?php if(!empty($playlists)): ?>
                                  <?php $__currentLoopData = $playlists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a class = "la-playlist__modal-item list-group-item targets_playlists" href="#" role="button" onclick="submitAddToPlaylist(<?php echo e($p->id); ?>)"><?php echo e($p->name); ?></a>   
...
<?php /**PATH C:\xampp\htdocs\lila-laravel\resources\views/components/add-to-playlist.blade.php ENDPATH**/ ?>