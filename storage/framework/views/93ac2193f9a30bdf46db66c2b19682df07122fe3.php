...
<footer class="la-footer">
                ...
                <div class="col-6 mb-10 mb-md-5">
                  ...
                  <ul class="la-footer__list">
                    <?php $__currentLoopData = $footer_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li class="la-footer__list-item"><a href="#" class="la-footer__list-link" ><?php echo e($fc->title); ?></a></li>
                ...
                <div class="col-6 mb-10 mb-md-5">
                  ...
                  <ul class="la-footer__list">
                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li class="la-footer__list-item"><a class="la-footer__list-link" href="/learn/course/<?php echo e($c->id); ?>/<?php echo e($c->slug); ?>"><?php echo e($c->title); ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </ul><a class="la-footer__more" href="/browse/courses">See all</a>
                </div>
            ...
            <div class="col-12 col-lg-4">
              <!-- <div class="la-footer__search"> -->
                ...
                <!-- <div class="la-gsearch mb-md-4">
                  <form class="form-inline d-flex align-items-start" action="<?php echo e(url('/search-course/')); ?>" method="get">
                    <div class="form-group ">
                      <input class="la-gsearch__input w-100 form-control la-gsearch__input-footersearch" style="border-left:1px solid rgba(229,229,229,0.2); background:transparent;font-size:15px" type="text" name="course_name" value="<?php echo e(isset($search_input)?$search_input:''); ?>" required placeholder="What you want to learn today?">
                    </div>
  ...
  <!-- Footer: End--><?php /**PATH C:\xampp\htdocs\lila-laravel\resources\views/learners/pages/footer.blade.php ENDPATH**/ ?>