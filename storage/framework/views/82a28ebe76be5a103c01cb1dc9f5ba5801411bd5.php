            ...
            <tbody>
              ...
              <?php $__currentLoopData = $cor->review; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <td><?php echo $i;?></td>
                  ...
                  <td><a class="btn btn-success btn-sm" href="<?php echo e(url('reviewrating/'.$jp->id)); ?>"><i class="la-icon la-icon--lg icon-edit"></i></a></td> 
...
<?php /**PATH E:\lila-laravel\resources\views/admin/course/reviewrating/index.blade.php ENDPATH**/ ?>